...
int main(){
    ...
    // write chopped imu
    std::string imuFileOut=testutils::getProjectRootDir()+"/test/output/testfile.h5";
    ...
    std::string imuMapFileOut=testutils::getProjectRootDir()+"/test/output/testfilemap.h5";
