...
int main(int argc, char** argv){
    ...
    uint startTime=strtol(argv[3],nullptr,0);
    uint stopTime=strtol(argv[4],nullptr,0);
    ...
    uint startTimeIdx=datapkgr::getNearestIdxFromVector<uint>(ImuMap.begin()->second.unixTimeUtc, startTime);
    uint stopTimeIdx=datapkgr::getNearestIdxFromVector<uint>(ImuMap.begin()->second.unixTimeUtc, stopTime);
    // now cut imu map
